    ...
    $(document).ready(function () {
        ...
        function colorize(polygons, json) {
            ...
            for (var i in polygons) {
                ...
                var squareMetric = polygon.properties[currentMetric];
                if (squareMetric != undefined) {
                    ...
                    color = hexFromRGB((255 * n) / 100, (200 * (100 - n)) / 100, 0);
                } else {
                    color = hexFromRGB(0, 0, 0);
                }
                polygon.setOptions({
                    strokeColor: color,
                    fillColor: color
        ...
        function drawPolygons(json) {
            ...
            for (var i in json.features) {
                ...
                google.maps.event.addListener(polygon, 'mouseover', function () {
                    ...
                    infoBubble.setContent('<div class="phoneytext">' + (this.properties[currentMetric] != undefined ? this.properties[currentMetric] +'%' : 'Нет данных') + '</div>');
